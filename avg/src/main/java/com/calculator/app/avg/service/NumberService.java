...
public class NumberService {
    ...
    public Map<String, Object> fetchNumbers(String type, String token) {
        ...
        try {
            ResponseEntity<NumberResponse> response = restTemplate.exchange(url, HttpMethod.GET, entity, NumberResponse.class);
            ...
            return Map.of("error", "API Error: " + e.getResponseBodyAsString());
        }
    }
}
